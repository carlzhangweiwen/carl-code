...
public class ImgScaleTest {
	 ...
	 */  
	    ...
	    public static void main(String[] args) {   
	        ImgScaleTest mypic = new ImgScaleTest();   
	        System.out.println("输入的图片大小：" + mypic.getPicSize("e:\\2.jpg")/1024 + "KB");   
	        int count = 0; // 记录全部图片压缩所用时间  
	        for (int i = 0; i < 100; i++) {   
	            int start = (int) System.currentTimeMillis();   // 开始时间   
	            mypic.compressPic("e:\\", "e:\\data\\", "2.jpg", "r1"+i+".jpg", 120, 120, true);   
